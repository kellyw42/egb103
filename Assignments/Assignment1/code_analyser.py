...
def appropriate_loop(function) :
    ...
    if name == 'vector_magnitude' or name == 'compute_gravitational_force' or name == 'compute_spring_force' or name == 'compute_new_velocity' or name == 'compute_new_position' or name == 'vector_norm' :
        return no_loops(function)
    elif name == 'sum_vectors' :
        return foreach_loop(function)
    elif name == 'compute_forces' or name == 'simulate_one_iteration' or name == 'simulate_fixed_number_of_timesteps' :
...
def use(function) :
    name = function.__name__
    if name == 'vector_norm' :
        return uses(function, ['vector_magnitude'])
    elif name == 'sum_vectors' :
        return uses(function, ['vector_sum'])        
    elif name == 'compute_spring_force' :
        return uses(function, ['vector_difference', 'vector_norm', 'vector_magnitude', 'scalar_multiply'])        
    elif name == 'compute_new_position' :
        return uses(function, ['vector_sum', 'scalar_multiply'])      
    elif name == 'compute_new_velocity' :
        return uses(function, ['vector_sum', 'scalar_multiply'])  
    elif name == 'compute_forces' :
        return uses(function, ['compute_total_force_on_one_part'])  
    elif name == 'simulate_one_iteration' :
        return uses(function, ['compute_forces', 'compute_new_velocity', 'compute_new_position'])  
    elif name == 'simulate_fixed_number_of_timesteps' :
        return uses(function, ['initialize_positions', 'simulate_one_iteration'])  
    else :
        return 0
...
def expected_complexity(function) :
    name = function.__name__
    if name == 'vector_magnitude' or name == 'compute_gravitational_force' or name == 'compute_spring_force' or name == 'compute_new_velocity' or name == 'compute_new_position' :
        return 1
    else :
        return 2
...
def meaningful_names() : 
    ...
    exclude = ['compute_forces', 'compute_gravitational_force', 'compute_new_position', 'compute_new_velocity', 'compute_spring_force', 'count', 'force', 'list_of_vectors', 'old_position', 'old_velocity', 'position_here', 'position_other_end', 'simulate_fixed_number_of_timesteps', 'simulate_one_iteration', 'sum_vectors', 'vector', 'vector_magnitude', 'vector_norm', 'velocity', 'x', 'y', 'compute_total_force_on_one_part','dt','equilibrium_spring_length','initialize_positions','mass','math','number_of_particles','scalar_divide','scalar_multiply','spring_constant','vector_difference','vector_sum']
...
def test_complexity(total_marks) :
    ...
    try :
        ...
        if good1 == 10 :
            ...
            mark = int(total_marks * (good1/10) * 2) / 2
            grand_total += mark
...
def assess_criteria(list) :
    ...
    Heading('Assessment Criteria 1a: vector_magnitude function implemented correctly') 
    summarize_results('testa', 2)
    
    Heading('Assessment Criteria 1b: vector_norm function implemented correctly') 
    summarize_results('testb', 4)
        
    Heading('Assessment Criteria 1c: sum_vectors function implemented correctly') 
    summarize_results('testc', 3)
    
    Heading('Assessment Criteria 1d: compute_gravitational_force function implemented correctly') 
    summarize_results('testd', 2)
    
    Heading('Assessment Criteria 1e: compute_spring_force function implemented correctly') 
    summarize_results('teste', 5, 2)
    
    Heading('Assessment Criteria 1f: compute_new_velocity function implemented correctly') 
    summarize_results('testf', 3)
    
    Heading('Assessment Criteria 1g: compute_new_position function implemented correctly') 
    summarize_results('testg', 3)
    
    Heading('Assessment Criteria 1h: compute_forces function implemented correctly') 
    summarize_results('testh', 2, 2)
    
    Heading('Assessment Criteria 1i: simulate_one_iteration function implemented correctly') 
    summarize_results('testi', 4, 2)
    
    Heading('Assessment Criteria 1j: simulate_fixed_number_of_timesteps function implemented correctly') 
    summarize_results('testj', 9)        
